<template>
  <div id="app">
    <div class="nav">
      <router-link to="/"><h2 class="logo">Minehunt.io</h2></router-link>
      <div class="nav-menu">
